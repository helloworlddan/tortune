...
var (
	db = [...]string{
		...
		"Interviewer: What's your expertise?\nMe: Machine Learning.\nInterviewer: Let's start with Basic Math. What is 3 times 4?\nMe: No idea.\nInterviewer: Seriously? the easiest one? It's 12. How much is 4 times 5?\Me: 12.",
	}
)
